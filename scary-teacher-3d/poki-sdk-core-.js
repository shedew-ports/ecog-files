(() => {
  ...
  (() => {
    ...
    var Ri, Li = "pokiSdkContainer1",
      Oi = "pokiSdkFixed",
      ji = "pokiSdkOverlay",
      Ni = "pokiSdkHidden",
      Gi = "pokiSdkInsideContainer",
      Ui = "pokiSdkPauseButtonContainer",
      Fi = "pokiSdkPauseButton",
      qi = "pokiSdkPauseButtonBG",
      Hi = "pokiSdkStartAdButton",
      Vi = "pokiSdkProgressBar",
      Qi = "pokiSdkProgressContainer",
      Zi = "pokiSdkSpinnerContainer",
      Wi = "pokiSdkVideoContainer",
      Xi = "pokiSdkVisible",
      Ji = "pokiSDKAdContainer",
      Ki = "pokiSDKHouseAdContainer",
